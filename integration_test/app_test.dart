...
void main() {
  group("App Test", () {
    ...
    testWidgets('Dashboard Page ElevatedButton test',
          ...
          expect(
              (find.byKey(Key('dashboardTitle')).evaluate().single.widget as Text)
                  .data,
              'Factory 1');
    ...
    testWidgets('Settings Page navigation and interaction test',
            (WidgetTester tester) async {
          // Build our app and trigger a frame.
          await tester.pumpWidget(MyApp());
